...
En este primer ejercicio se pide realizar un escáner I2C con el objetivo de detectar dispositivos conectados al bus I2C de nuestro microcontrolador ESP32-S3, de tal forma que muestre vía monitor serie las direcciones de los dispositivos I2C. Así pues, una vez realizado el siguiente montaje:

![image](https://github.com/user-attachments/assets/3b233e84-4a46-413e-972a-04ec21dccc36)

Y ejecutado el siguiente codigo:
...
Podemos ver en el serial monitor el siguiente mensaje:


![image](https://github.com/user-attachments/assets/e73a9e8a-9c8f-48de-894e-a66fac4af247)

## EJERCICIO PRÁCTICO 2
En este segundo ejercicio, se usa una pantalla OLED para que muestre el mensaje en lugar de usar el serial monitor, de tal manera que una vez realizado el montaje, instaladas las librerías (Adafruit) y ejecutado el código:
...
![image](https://github.com/user-attachments/assets/29758f81-8225-40f6-afe3-c08e82b6cee9)

Además hemos realizado este ejercicio de manera que hemos introducido un mensaje personalizado para que lo muestre por la pantalla OLED y el montaje y código realizados ha sido el siguiente:
...
![image](https://github.com/user-attachments/assets/fa85d032-9340-4f8f-ab90-d640b98d529c)

## EJERCICIO PRÁCTICO EXTRA
En este primer ejercicio extra hemos realizado un código que mediante un sensor MAX30105 y una pantalla OLED se inicializa la comunicación I2C y el sensor recoge 100 muestras de luz infrarroja para calcular el ritmo cardíaco y la saturación de oxígeno en sangre para mostrar los resultados por la pantalla OLED. 
Para la realización de este ejercicio hemos instalado la librería SparkFun Max3010x.
...
## EJERCICIO PRÁCTICO EXTRA 2
Esta segunda parte de la práctica extra realiza el mismo ejercicio con los mismos cálculos y procedimientos con la pequeña diferencia de que esta vez se conecta a una red WiFi y además de mostrar los resultados por el monitor serial y por la pantalla OLED, también los muestra por una página web html generada en el mismo código.
